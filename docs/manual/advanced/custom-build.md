...
1. [Set up your build environment.]({% link manual/advanced/install.md %}#setting-up-your-build-environment)
...
3. [Rebuild and flash]({% link manual/advanced/install.md %}#building-firmware) the customized firmware to your keyboard.
...
After adjusting limits, rebuild and flash the firmware to apply them. See also the [firmware size guide]({% link docs/firmware-size.md %}).
...
[QMK Community Modules](https://docs.qmk.fm/features/community_modules) allow for sharing and using third-party features. It is possible to use modules in a custom Vial build.
